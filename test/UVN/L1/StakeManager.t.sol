...
contract StakeManagerTest is L1TestHandler {
    ...
    function setUp() public override {
        super.setUp();
        stakeManager = new StakeManagerTestWrapper(
            address(stakeToken),
            initialAdmin,
            WITHDRAWAL_DELAY,
            slashingBeneficiary
    ...
    function test_withdraw() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(IStakeManager.NoPendingWithdrawalsToWithdraw.selector, uint64(block.timestamp + WITHDRAWAL_DELAY)));
