...
checkpoints (and voting), in which case [CLOCK_MODE](/src/UVN/L1/StakingMiddleware/libraries/Votes.sol/abstract.Votes.md#clock_mode) should be overridden as well to match.*
...
Emits events [IVotes-DelegateChanged](/lib/unistaker/lib/openzeppelin-contracts/contracts/governance/utils/IVotes.sol/interface.IVotes.md#delegatechanged) and {IVotes-DelegateVotesChanged}.*
